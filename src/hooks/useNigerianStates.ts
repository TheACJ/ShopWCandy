...
const useNigeriaStates = () => {
  ...
  const states = {
    Abia: [
      ...
      "Ukwa East", "Ukwa West", "Umuahia North", "muahia South", "Umu Nneochi"
    ],
    Adamawa: [
  ...
  useEffect(() => {
    if (selectedState) {
      setAvailableLGAs(states[selectedState] || []);
...
export default useNigeriaStates;